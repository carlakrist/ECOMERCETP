...
def registro_usuario():#Diccionario con los datos de reg/lo Valida y RETORNA USER
    FormularioUSER={}
...
def update_usuario(user):#Diccionario con los datos - lo Valida y RETORNA el Diccionario
    FormularioUSER={}
    FormularioUSER['DNI']=input("DNI: ")
    FormularioUSER['Nombre']=input("Nombre: ")
    FormularioUSER['Apellido']=input("Apellido: ")
    ...
    if not errores:
            USUARIO=usuario(**FormularioUSER)
